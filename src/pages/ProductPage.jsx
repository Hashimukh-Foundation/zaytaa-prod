...
export default function ProductPage() {
  ...
  // Reset the "Go to Cart" button back to "Add to Cart" if user changes variant or quantity
  useEffect(() => {
    setIsAdded(false);
  ...
  const renderContent = () => {
    ...
    const handleCartAction = (e) => {
      ...
      if (isAdded) {
        // If already added, navigate to the cart page
        navigate("/checkout");
      } else {
    ...
    const handleWhatsAppOrder = () => {
      // Replace with your business WhatsApp number (include country code, omit '+' or spaces)
      const whatsappNumber = "8801838467884";

      const variantText = selectedVariant
        ? ` (Variant: ${selectedVariant.name})`
        : "";
      const activePrice = currentSalePrice || currentPrice;
          ...
          <div style={styles.info}>
            <div style={styles.topMetaRow}>
              {brand ? (
                ...
                <span style={styles.brandLink}>Zaytaa Cosmetics</span>
              )}
            ...
            {/* Action Container for Cart and WhatsApp */}
            <div style={styles.actionContainer}>
              ...
              <button onClick={handleWhatsAppOrder} style={styles.whatsappBtn}>
